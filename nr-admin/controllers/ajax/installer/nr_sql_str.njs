module.exports=function(nr_data)
{
	var default_theme_option={"area_widget_linking":{"right_side_panel":[{"widget_id":"nr_search_widget","properties":{"search_widget_title":"Search"}},{"widget_id":"nr_recent_post_widget","properties":{"title":"Recent Posts","posts_per_page":"8","post_type":"post"}}]}};
	...
	('c', 'core', '{}', 1),\
	('semplicemente', 'theme', '"+JSON.stringify(default_theme_option)+"', 1),\
	('test_1', 'plugin', NULL, 1);\
	\
