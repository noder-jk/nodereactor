...
var FileDetails = function FileDetails(props) {
  ...
  return _react["default"].createElement("div", {
    ...
    return _react["default"].createElement("tr", {
      key: item.post_name
    }, _react["default"].createElement("td", null, _react["default"].createElement(_renderMedia.RenderMediaFile, {
      url: item.file_url,
      mime: item.mime_type,
  ...
  _createClass(Browser, [{
    ...
    value: function deleteFile() {
      ...
      var del_fnc = function del_fnc(result) {
        ...
        (0, _react2.ajax_request)('nr_delete_media', {
          post_id: post_id
        }, function (r, d, e) {
          if (e) {
    ...
    value: function getMedia(page_num) {
      ...
      (0, _react2.ajax_request)('nr_get_gallery', ob, function (r, d, e) {
        if (e) {
          _this3.setState({
            'spinner': null,
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", _defineProperty({
        ...
        return _react["default"].createElement("span", {
          ...
          className: cls
        }, _react["default"].createElement(_renderMedia.RenderMediaFile, {
          url: item.file_url,
          extension: item.file_extension,
          mime: item.mime_type,
          style: {
