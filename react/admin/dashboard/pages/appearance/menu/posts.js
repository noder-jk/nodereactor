...
/*#__PURE__*/
function (_Component) {
  _inherits(PostItems, _Component);

  function PostItems(props) {
    var _this;

    _classCallCheck(this, PostItems);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(PostItems).call(this, props));
    _this.state = {
      'checked': [],
      'items': {}
    };
    ...
    value: function adder() {
      ...
      checked.map(function (id) {
        Object.keys(_this2.state.items).map(function (p_type) {
          _this2.state.items[p_type].map(function (post) {
            if (id == post.post_id) {
              ret.push({
                'post_id': id,
