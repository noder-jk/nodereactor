...
import {ajax_request, Pagination} from 'nodereactor/react';
...
class Browser extends Component
{
    ...
    deleteFile()
    {
        ...
        let del_fnc=(result) => 
        {
            ...
            ajax_request('nr_delete_media', {post_id}, (r, d, e)=>
            {
                if(e)
                {
    ...
    getMedia(page_num)
    {
        ...
        ajax_request('nr_get_gallery', ob, (r, d, e)=>
        {
            if(e)
            {
        ...
        return <div className="attachment_browser" className="attachments-browser">
            <div className="attachments" style={json}>	
                ...
                <div className="text-center mt-1 mb-1">
                    <Pagination pgn={this.state.pagination} activeClass="btn btn-outline-secondary btn-sm ml-1 mr-1" inactiveClass="btn btn-secondary btn-sm ml-1 mr-1" onClick={this.handlePaginate}/>
                </div>
            </div>
